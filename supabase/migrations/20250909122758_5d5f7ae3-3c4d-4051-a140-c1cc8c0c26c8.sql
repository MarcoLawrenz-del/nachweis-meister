-- STEP 1: Compliance Engine - Unified States and Requirement Rules

-- Create unified status enum for requirements
...
-- Update requirements table to use new enum and add missing columns
ALTER TABLE public.requirements 
  ALTER COLUMN status TYPE public.requirement_status USING status::public.requirement_status,
